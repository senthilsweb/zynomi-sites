            ...
            <div class="w-screen max-w-md">
                <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-2xl">
                    <div class="flex-1 h-0 overflow-y-auto">
                        <header class="space-y-1 py-6 px-4 bg-gradient-to-r from-fuchsia-900 via-indigo-700 to-fuchsia-900 sm:px-6">
                            <div class="flex items-center justify-between space-x-3">
                                <h2 class="text-lg leading-7 font-medium text-white">
                                    Contact Us
                                </h2>
                                <div class="h-7 flex items-center">
                                    <button v-on:click="isContactFormVisible=false" aria-label="Close panel" class="text-fuchsia-200 hover:text-white transition ease-in-out duration-150">
                    ...
                    <div class="w-full flex-shrink-0 px-4 py-4 space-x-4 flex justify-end">
                        ...
                        <span class="inline-flex rounded-md shadow-sm">
                            <button v-on:click="sendContactUs" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium  text-white bg-fuchsia-600 hover:bg-fuchsia-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-fuchsia-700 transition duration-150 ease-in-out">
                                Save
                            </button>
                        </span>
                    </div>
